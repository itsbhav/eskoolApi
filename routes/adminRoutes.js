...
router
  ...
  .post(upload.single("myFile"), advertisementsController.postAdvertisement)
...
router.route("/fee/mark").put(feeController.markFee);
router
  .route("/notices")
  .get(noticesController.getAll)
  .post(upload.single("myFile"), noticesController.postNotice)
  .delete(noticesController.deleteNotice);
router.route("/teacher").get(teacherController.getTeachers);
router
  .route("/teacher/verifiedByAdmin")
  .put(teacherController.confirmedByTeacher);
router.route("/teacher/verifiedByTeacher").put(teacherController.verifyTeacher);
router.route("/user").get(userController.getStudents);
router
  .route("/marks")
