...
router.route("/fee").get(feeController.getYourFee);
router.route("/mark").get(feeController.getYourMarks);
router.route("/lecture").get(lectureController.getLecturesByCourse);
router.route("/assignment").get(lectureController.getAssignmentsByCourse);
